...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="mt-0 text-dark">Contact us</h2>
                ...
                <div class="row">
                  <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                    ...
                    <div class="text-dark"><?php echo $_SESSION['system']['contact'] ?></div>
                  </div>
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2023 - <?php echo $_SESSION['system']['name'] ?> | <a href="https://www.lolwe.com/" target="_blank">Lolwe</a></div></div>
        </footer>
